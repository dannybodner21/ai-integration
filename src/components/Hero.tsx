  ...
  return (
    <>
      <motion.div className="relative w-full" initial="hidden" animate="visible" variants={containerVariants}>
        <div className={`banner-container bg-black relative overflow-hidden w-full ${
          isChatExpanded 
            ? 'h-auto min-h-[70vh] sm:min-h-[80vh] md:min-h-[700px] lg:min-h-[750px] xl:min-h-[800px]' 
            : 'h-[70vh] sm:h-[80vh] md:h-[700px] lg:h-[750px] xl:h-[800px]'
        }`}>
          ...
          <div className="banner-overlay bg-transparent pt-20 sm:pt-24 md:pt-32 w-full">
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center min-h-full py-8">
              <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
                <motion.h1 className="banner-title text-white" variants={itemVariants}>Unlock 6–7 Figures of Hidden Profit in 14 Days With Custom AI & SaaS Tools</motion.h1>
                ...
                {/* AI Chat Section - moved here to come right after the subtitle */}
                ...
                <motion.div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 justify-center items-center" variants={itemVariants}>
                  ...
                  >
                    Book Your 15-Minute Fit Call TEST
                    <MessageSquare className="ml-2 w-4 w-4 sm:w-5 sm:h-5 group-hover:scale-110 transition-transform" />
                  </button>

                  {/* See what we can build */}
                  <Link
                    to="/apps"
                    className="w-full sm:w-auto min-h-[44px] px-6 sm:px-8 py-3 bg-white text-gray-700 rounded-md hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl border border-gray-200 flex items-center justify-center group text-sm sm:text-base font-medium"
                  >
                    See what we can build
